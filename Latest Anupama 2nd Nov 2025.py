...
def analyze_and_build_rows(dhan_client, instrument_df, df_losers, symbols_df):
    ...
    for i, r in enumerate(df_losers.itertuples(), 1):
        ...
        try:
            ...
            name_row = symbols_df[symbols_df['Symbol'] == sym]
...
def main(dhan_client):
    ...
    df_losers = get_top_n_losers_first5(dhan_client, instrument_df, symbols_df)
    print ("df_losers", df_losers)
    ...
    rows = analyze_and_build_rows(dhan_client, instrument_df, top_symbols, symbols_df)
